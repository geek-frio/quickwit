...
use quickwit_proto::opentelemetry::proto::trace::v1::span::SpanKind;
            ...
            for scope_span in resource_span.scope_spans {
                for span in scope_span.spans {
                    ...
                    let span = Span {
                        ...
                        span_id,
                        span_kind: to_span_kind(span.kind).as_str_name().to_string(),
                        span_name,
...
fn to_span_kind(span_kind_id: i32) -> SpanKind {
    match span_kind_id {
